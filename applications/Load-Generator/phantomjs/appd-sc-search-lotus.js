...
page.settings.userAgent = 'Mozilla/5.0 (Linux; Android 8.0.0;) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Mobile Safari/537.36';
...
steps = [
    ...
    function(){
		...
		page.evaluate(function(){
			document.getElementById("criteria").value="Lotus";
